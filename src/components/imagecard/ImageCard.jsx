...
const ImageCard = ({ photo, isLast, loadMoImageRef, onClick }) => {
  return (
    <div className={css.blokimg} onClick={() => onClick(photo)}>
      <img
        ref={isLast ? loadMoImageRef : null}
        ...
        className={css.img}
        onLoad={() => {
          if (isLast && loadMoImageRef?.current) {
